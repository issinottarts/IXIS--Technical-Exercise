...
* Chrome and Desktop were the best combination for a higher number of transactions
and quantity.
...
The raw data appears to follow a poisson distribution, 
because the data is independent and clustered near the origin.
